...
!(function () {
  ...
  document.addEventListener("appReady.EappsInstagramFeed", function () {
    ...
    Array.prototype.slice.call(e).forEach(function (e) {
      ...
      window.eappsInstagramFeed(e, i),
        e.removeAttribute("data-elfsight-instagram-feed-options"),
        e.removeAttribute("data-elfsight-instagram-feed-version"),
        (e.data = { options: i, version: t });
    });
  }),
    (function (e) {
      var t = {};
        ...
        e.exports = function (e, t) {
          ...
          if ((n = h ? i : g ? i[m] || s(m, {}) : (i[m] || {}).prototype))
            for (l in t) {
              if (
                ((f = t[l]),
                (p = e.noTargetGet ? (d = r(n, l)) && d.value : n[l]),
      ...
      function (e, t, n) {
        var i = n(1),
          ...
          ce = function (e) {
            ...
            return (
              !(this === W && p(q, t) && !p(Q, t)) &&
              (!(n || !p(this, t) || !p(q, t) || (p(this, F) && this[F][t])) ||
                n)
            );
          },
          ue = function (e, t) {
            ...
            if (n !== W || !p(q, i) || p(Q, i)) {
              var r = G(n, i);
              return (
                !r || !p(q, i) || (p(n, F) && n[F][i]) || (r.enumerable = !0), r
              );
            }
          },
          le = function (e) {
        ...
        c ||
          (P(
            (H = function () {
              ...
              return (
                s && ne && ie(W, t, { configurable: !0, set: n }), re(t, e)
              );
            }).prototype,
            "toString",
            function () {
          ...
          s &&
            ...
            a || P(W, "propertyIsEnumerable", ce, { unsafe: !0 }))),
          i({ global: !0, wrap: !0, forced: !c, sham: !c }, { Symbol: H }),
          N(w(ee), function (e) {
            D(e);
          }),
          i(
      ...
      function (e, t, n) {
        ...
        e.exports = function (e) {
          return (
            o(u, e) ||
              (s && o(l, e) ? (u[e] = l[e]) : (u[e] = p("Symbol." + e))),
            u[e]
          );
        };
      },
      ...
      function (e, t, n) {
        n(1)({ target: "Object", stat: !0 }, { setPrototypeOf: n(95) });
      },
      function (e, t, n) {
        var i,
          r,
              ...
              I(function () {
                for (var r = t.value, o = 1 == t.state, a = 0; i.length > a; ) {
                  ...
                  try {
                    p
                      ? (o ||
                          (2 === t.rejection && te(e, t), (t.rejection = 1)),
                        !0 === p
                          ? (s = r)
                          : (m && m.enter(),
                            (s = p(r)),
          ...
          $ = function (e, t, n) {
            var i, r;
            Y
              ? (((i = V.createEvent("Event")).promise = t),
                (i.reason = n),
                i.initEvent(e, !1, !0),
                u.dispatchEvent(i))
          ...
          K = function (e, t) {
            L.call(u, function () {
              ...
              if (
                ...
                ((n = C(function () {
                  G
                    ? U.emit("unhandledRejection", i, e)
                    : $("unhandledrejection", e, i);
                })),
          ...
          { target: "Array", proto: !0, forced: !d || !m },
          {
            slice: function (e, t) {
              ...
              if (
                ...
                return g.call(p, d, m);
              for (
                i = new (void 0 === n ? Array : n)(v(m - d, 0)), l = 0;
                d < m;
                d++, l++
              )
                d in p && u(i, l, p[d]);
      ...
      function (e, t, n) {
        var i = n(1),
          r = n(202);
        i(
          { target: "String", proto: !0, forced: n(203)("link") },
          {
            link: function (e) {
          ...
          (s = function (e) {
            ...
            return (
              ...
              f
                ...
                : c &&
                  r &&
                  (p.lastIndex = p.global ? r.index + r[0].length : t),
              l &&
                r &&
                r.length > 1 &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    n.top >= 0 - r &&
                    n.left >= 0 - i &&
                    n.bottom <= window.innerHeight + r &&
                    n.right <= window.innerWidth + i
                  );
                },
              },
              {
        ...
        i(
          { target: "Object", stat: !0, sham: !r },
          {
            getOwnPropertyDescriptors: function (e) {
              for (
                var t, n, i = a(e), r = s.f, u = o(i), l = {}, p = 0;
                u.length > p;

              )
                void 0 !== (n = r(i, (t = u[p++]))) && c(l, t, n);
              return l;
            },
          }
        );
        ...
        var k = (function () {
          function e(t) {
            ...
            !(function (e, t) {
              ...
              (this.accessToken = this.allowUsername
                ? this.tuner.get("accessToken")
                : void 0),
              (this.users = []),
              (this.usersPromised = []),
              (this.userPromises = []);
            ...
            })(e, [
              {
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, i) {
                    new b.a(t.dependencies, e, null, !0).fetch().then(
                      function (e) {
                        if (e && e[0]) {
                          var r = e[0];
                          (t.users[r.id] = r), n(r);
                ...
                value: function () {
                  ...
                  return new Promise(function (t) {
                    ...
                    (n.filtersScheme = e.createFiltersScheme({
                      ...
                      "string" == typeof n.customFilter &&
                        "function" == typeof window[n.customFilter] &&
                        (n.customFilter = window[n.customFilter]),
                      (e.filters = n),
                      e.getFiltersFormatted(n.filtersScheme).then(function (i) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n) {
                    var i = {},
                      r = function (n) {
                        if (e.hasOwnProperty(n)) {
                          var r = e[n];
                          void 0 === i[r.type] && (i[r.type] = {}),
                            void 0 === i[r.type][r.logic] &&
                              (i[r.type][r.logic] = []);
                          var o = r.name;
                          t.allowUsername && "user" === r.type
                            ? t.accessToken ||
                              t.userPromises.push(
                                t.getUserByName(o).then(
                                  function (e) {
                    ...
                    for (var o in e) r(o);
                    Promise.all(t.userPromises).then(
                      function () {
                        return n(i);
                      },
                      function () {
                    ...
                    for (var n in e)
                      if (e.hasOwnProperty(n)) {
                        ...
                        if (i && i.length) {
                          var r = Object(y.a)(i);
                          for (var o in r)
                            r.hasOwnProperty(o) && (r[o].logic = n);
                    ...
                    if (t.formattedFilters.hasOwnProperty(i)) {
                      ...
                      switch (i) {
                        case "specific_media_shortcode":
                          (n &=
                            !r.only ||
                            r.only.some(function (t) {
                              return !!~e.link.indexOf(t);
                            })),
                            (n &= !(
                              r.except &&
                              r.except.some(function (t) {
                                return !!~e.link.indexOf(t);
                              })
                            ));
                          break;
                        case "tag":
                          if (
                            ...
                            for (var o in r.only)
                              r.only.hasOwnProperty(o) &&
                                (n &= !!~e.tags.indexOf(r.only[o]));
                          n &= !(
                            r.except &&
                            r.except.some(function (t) {
                        ...
                        case "user":
                          this.allowUsername &&
                            ((n &= !(
                              r.only &&
                              r.only.length &&
                              !~r.only.indexOf(e.user.id)
                            )),
                            (n &= !(
                              r.except &&
                              r.except.length &&
                              ~r.except.indexOf(e.user.id)
                            )));
                          break;
                        case "location":
                          e.location
                            ? ((n &=
                                !r.only || !!~r.only.indexOf(e.location.id)),
                              (n &=
                                !r.except || !~r.except.indexOf(e.location.id)))
                            : (n = !1);
                      }
                    }
                  return (
                    n &&
                      "function" == typeof t.customFilter &&
                      (n = !!t.customFilter(e)),
                    n
                  );
                },
                ...
                value: function (e, t, n) {
                  ...
                  if (
                    ...
                    (n = n || {}),
                      ...
                      this.lastItemId &&
                        (n[this.maxIdParameterName] = this.lastItemId),
                      this.request(n).then(
                        function (n) {
                          var r = n.data;
                          Array.isArray(r) || (r = [r]),
                            r.length && (i.lastItemId = r[r.length - 1].id);
                          var o = function (n) {
                            (i.items = i.items.concat(n)), i.fetch(e, t);
                          };
                          i.filterFunc
                            ? i.filterFunc(r).then(function (e) {
                                o(e);
                              })
                            : o(r);
                        },
      ...
      function (e, t, n) {
        ...
        (e.exports = function (e, t, n, l, p) {
          ...
          for (v = f.next; !(y = v.call(f)).done; )
            if (
              "object" == typeof (g = c(f, b, y.value, l)) &&
              g &&
              g instanceof u
            )
              return g;
              ...
              [
                ...
                function (e, r) {
                  ...
                  for (var w = 0, x = 0, k = []; x < f.length; ) {
                    ...
                    if (
                      null === L ||
                      (S = m(u(y.lastIndex + (h ? 0 : x)), f.length)) === w
                    )
                      x = c(f, x, g);
                    else {
              ...
              if ((c < 0 && ((d = "-"), (c = -c)), c > 1e-21))
                if (
                  ((n =
                    (t =
                      (function (e) {
                        for (var t = 0, n = c * l(2, 69, 1); n >= 4096; )
                          (t += 12), (n /= 4096);
                        for (; n >= 2; ) (t += 1), (n /= 2);
                        return t;
                      })() - 69) < 0
        ...
        var m = (function () {
          function e(t, n) {
            !(function (e, t) {
              ...
              (this.platform = n),
              "instagram" === n &&
                (this.userId = this.tuner.get("personalAccessToken")),
              "facebook" === n &&
                (this.userId = this.tuner.get("businessAccessToken")),
              (this.widgetId = this.tuner.get("widgetId")),
              (this.apiProxyUrl =
                this.tuner.get("apiProxyUrl") || f.a.apiProxyUrl),
              (this.cacheTime = 3600),
              (this.debug =
                p.a.others.isLocalStorageAvailable() &&
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, i) {
                    var r = e,
                      o = e,
                      a = function () {
                        var a = { start: new Date().getTime() };
                        return fetch(e, { method: "GET", mode: "cors" })
                          .then(function (e) {
                            return e.json();
                          })
                          .then(
                            function (e) {
                              t.log(!!e.error, o, e, a),
                                window.globalProfiler &&
                                  (window.globalProfiler.end = a.end =
                                    new Date().getTime()),
                                e.error ? i(e) : (t.cache.save(r, e), n(e));
                            },
                            function () {
                              return i();
                            }
                    ...
                    t.cache.connect().then(
                      function () {
                        t.cache.getSaved(r, t.cacheTime).then(
                          function (e) {
                            return n(e);
                          },
                          function () {
                ...
                value: function (e, t, n, i) {
                  if (this.debug) {
                    ...
                    var a = [
                      ...
                      "\n" +
                        [
                          "c: ".concat(window.requestCount),
                          "t: ".concat(i.end - i.start, "ms"),
                          "gt: ".concat(
                            window.globalProfiler.end -
                              window.globalProfiler.start,
                            "ms"
                          ),
                        ].join("; "),
                    ];
                    e
                      ? (o = console).log.apply(o, a)
              ...
              },
              {
                ...
                value: function (e) {
                  var t =
                    ...
                    r = ""
                      .concat(this.apiProxyUrl, "/api/")
                      .concat(this.platform, "?q=")
                      .concat(encodeURIComponent(i), "&user_id=")
                      .concat(this.userId);
                  return this.send(r);
                },
              },
          ...
          if (
            (C &&
              ...
              m !== Object.prototype &&
                ...
                (p ||
                  o(w) === m ||
                  (a ? a(w, m) : "function" != typeof w[g] && c(w, g, v)),
                s(w, L, !0, !0),
                p && (f[L] = v))),
            "values" == d &&
              O &&
            ...
            else i({ target: t, proto: !0, forced: h || I }, x);
          return x;
        };
      },
      function (e, t, n) {
      ...
      function (e, t, n) {
        ...
        (m && h) ||
          ...
          "process" == c(g)
            ...
            : ((i = L), a.addEventListener("message", S, !1))),
            ...
            return (
              ...
              x(e, [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    var n,
                      ...
                      r = {};
                    (e = this.constructor.parseNames(e)).forEach(function (e) {
                      e in i.watchers || (i.watchers[e] = []),
                        i.watchers[e].push(function (i, o) {
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    e in this.watchers &&
                      this.watchers[e].forEach(function (e) {
                        return e(n, t);
                      });
                  },
                },
            ...
            return (
              x(e, null, [
                {
                  key: "sanitize",
                  value: function (e) {
                    return "object" === y(e) && null !== e
                      ? Object.assign(Array.isArray(e) ? [] : {}, e)
                      : e;
                  },
                },
              ]),
              x(e, [
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    return (
                      (t = this.constructor.sanitize(t)),
                      e in this.rules &&
                        this.rules[e].forEach(function (e) {
                          t = e(t);
                        }),
                      t
                    );
              ...
              x(e, [
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    return (
                      (e[t] = n),
                      this.changeWatcher.trigger(t, i, this.get(e, t)),
                      !0
                    );
                  },
                },
        ...
        var R = (function () {
          function e(t) {
            ...
            !(function (e, t) {
              ...
              (this.columns =
                parseInt(this.tuner.get("columns"), 10) || A.a.columns),
              (this.rows = parseInt(this.tuner.get("rows"), 10) || A.a.rows),
              (this.gutter =
                parseInt(this.tuner.get("gutter"), 10) || A.a.gutter),
              (this.layout = this.tuner.get("layout")),
              (this.breakpoints = this.prepareBreakpoints(
                this.tuner.get("responsive")
              )),
            ...
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    e || (e = []),
                    ("object" === _(e) && Object.entries(e).length) ||
                      Array.isArray(e))
                  ) {
                    for (var n in e)
                      if (e.hasOwnProperty(n)) {
                        ...
                        var r = Object.assign(!1, {}, i, { minWidth: n });
                        r.hasOwnProperty("columns") &&
                          (r.columns = parseInt(r.columns, 10) || A.a.columns),
                          r.hasOwnProperty("rows") &&
                            (r.rows = parseInt(r.rows, 10) || A.a.rows),
                          r.hasOwnProperty("gutter") &&
                            (r.gutter = parseInt(r.gutter, 10) || A.a.gutter),
                          t.push(r);
                      }
                ...
                value: function () {
                  var e = this,
                    t =
                      !(arguments.length > 0 && void 0 !== arguments[0]) ||
                      arguments[0],
                    n = this.posts.items.slice(
                      this.cursor,
                      this.cursor + this.itemsPerPage
                    );
                  if (!n.length) return !1;
                  this.cursor += n.length;
                  var i = new C.a(n, this);
                  return (
                    t && i.view.appendTo(this.view.postsInner),
                    this.pages.push(i),
                    setTimeout(function () {
                      i.init(), e.fitItems();
                    }),
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  this.updateBreakpoint() &&
                    this.rebuildViews().then(function () {
                      e.fitItems();
                    });
                },
              },
                ...
                value: function () {
                  ...
                  return (
                    ...
                    (t = t || this.defaultBreakpoint) !==
                      ...
                      (e = !0),
                      (this.columns = t.hasOwnProperty("columns")
                        ? t.columns
                        : this.defaultBreakpoint.columns),
                      (this.rows = t.hasOwnProperty("rows")
                        ? t.rows
                        : this.defaultBreakpoint.rows),
                      (this.gutter = t.hasOwnProperty("gutter")
                        ? t.gutter
                        : this.defaultBreakpoint.gutter)),
                ...
                value: function () {
                  if (this.posts.items.length) {
                    ...
                    this.view.element.classList.remove(
                      E.a.alias + "-posts-extra-small",
                      E.a.alias + "-posts-small",
                      E.a.alias + "-posts-medium",
                      E.a.alias + "-posts-large"
                    ),
                      e <= 150
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.view.postsInner.style.margin = "-".concat(
                    this.gutter / 2,
                    "px"
                  )),
                    this.innerWidth ||
                      (this.innerWidth =
                        this.view.postsInner.clientWidth +
                        ("slider" === this.layout ? this.gutter : 0)),
                    (this.view.postsInner.style.width = "".concat(
                      this.innerWidth,
                      "px"
                    )),
                    this.pages.forEach(function (n) {
                      if (
                        (n.items.forEach(function (n) {
                          (n.view.element.style.width = "calc("
                            .concat(t, "% - ")
                            .concat(e.gutter, "px)")),
                            (n.view.element.style.margin = "".concat(
                              e.gutter / 2,
                              "px"
                            )),
                            n.view.element.classList.add(
                              E.a.alias + "-posts-item-visible"
                            );
                        }),
                        n.items.length < e.columns * e.rows &&
                          "slider" === e.layout)
                      )
                        for (var i = 1; i < e.rows; i++)
                          if (n.items.length <= e.columns * i) {
                            n.view.element.style.height =
                              100 / (e.rows / i) + "%";
                            break;
                          }
                        ...
                        if ("slider" != e.layout || n.observer) {
                          if (M.a.others.inViewPort(n.view.element, 50)) {
                            ...
                            n.items.forEach(function (t) {
                              e.widget.viewedPosts.indexOf(t.data.code) + 1 ||
                                (e.widget.viewedPosts.push(t.data.code), r++);
                            }),
                              r && e.widget.analytics.store("posts-viewed", r);
                          }
                        } else
                          (n.observer = new MutationObserver(function (t, i) {
                            t.forEach(function (t) {
                              if (
                                (t.target.classList.contains(
                                  ...
                                  1 == e.pages.length) &&
                                M.a.others.inViewPort(n.view.element, 50)
                              ) {
                                var i = 0;
                                n.items.forEach(function (t) {
                                  e.widget.viewedPosts.indexOf(t.data.code) +
                                    1 ||
                                    (e.widget.viewedPosts.push(t.data.code),
                                    i++);
                                }),
                                  i &&
                                    e.widget.analytics.store("posts-viewed", i);
                              }
                            });
                          })),
                      ...
                      clearTimeout(t),
                        (t = setTimeout(function () {
                          n.pages.forEach(function (e) {
                            if (
                              ("grid" == n.layout ||
                                e.view.element.classList.contains(
                                  "eui-slider-slide-active"
                                ) ||
                                1 == n.pages.length) &&
                              M.a.others.inViewPort(e.view.element, 50)
                            ) {
                              var t = 0;
                              e.items.forEach(function (e) {
                                n.widget.viewedPosts.indexOf(e.data.code) + 1 ||
                                  (n.widget.viewedPosts.push(e.data.code), t++);
                              }),
                                t &&
                                  n.widget.analytics.store("posts-viewed", t);
                            }
                          });
                        }, 100));
                    };
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.view.postsInner.style.minHeight = e + "px"),
                    this.widget.view.loader.classList.add(
                      E.a.alias + "-loader-visible"
                    );
                },
              },
              {
                ...
                value: function () {
                  (this.view.postsInner.style.minHeight = 0),
                    this.widget.view.loader.classList.remove(
                      E.a.alias + "-loader-visible"
                    );
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  this.popup &&
                    (this.popup.isShowing() && this.popup.close(),
                    this.popup.destroy()),
                    (this.destroyed = !0);
                },
              },
          ...
          function n(e, i, r) {
            ...
            return (
              ...
              t.call(
                this,
                e,
                "/users/" + i + (o ? "/profile/" : "/media/recent/"),
                r,
                "max_id",
                o ? 1 : 50
              )
      ...
      function (e, t, n) {
        ...
        (k.polyfill = !0),
          i.fetch ||
            ((i.fetch = k), (i.Headers = l), (i.Request = v), (i.Response = b));
      },
      function (e, t, n) {
        n.d(t, "a", function () {
          return y;
        ...
        var y = (function (e) {
          ...
          function n(e, i, r) {
            return (
              ...
              t.call(this, e, "/media/shortcode/" + i, r, null, 1)
            );
          }
          return n;
        })();
        ...
        var L = (function () {
          function e(t, n) {
            ...
            !(function (e, t) {
              ...
              (this.parent = n),
              (this.items = i),
              (this.optionalStylesClasses = r),
              (this.STYLES_CLASSES = { bottom: "eui-popover-bottom" }),
              (this.opened = !1);
            var o = (function (e, t) {
              return (
                (function (e) {
            ...
            (function (e, t, n) {
            ...
            })(e, [
              {
                ...
                value: function () {
                  ...
                  return [
                    e,
                    e.querySelector(".eui-popover-content-inner"),
                    e.querySelector(".eui-popover-content"),
                  ];
                },
              },
              {
                    ...
                    this.items.forEach(function (t) {
                      ...
                      if ((e.inner.appendChild(n), t.handler)) {
                        ...
                        n.addEventListener("click", function (t) {
                          i.window
                            ? e.openWindow(i.window.url, "share")
              ...
              },
              {
                key: "fit",
                value: function () {
                  (this.widget && this.widget.length) ||
                    (this.widget = document.querySelector(
                      ".".concat(this.alias)
                    )),
                    parseInt(
                      this.parent.getBoundingClientRect().top -
                        this.widget.getBoundingClientRect().top,
                      10
                    ) <
                    this.inner.height +
                      parseInt(this.content.style.paddingBottom, 10)
                      ? this.element.classList.add("eui-popover-bottom")
                      : this.element.classList.remove("eui-popover-bottom"),
                    this.stylize();
                },
              },
              {
                ...
                value: function () {
                  ...
                  this.optionalStylesClasses.forEach(function (t) {
                    e.STYLES_CLASSES[t] &&
                      e.element.classList.add(e.STYLES_CLASSES[t]);
                  });
                },
              },
              {
                ...
                value: function () {
                  ...
                  return new Promise(function (t) {
                    ...
                    e.data.images.forEach(function (t, r) {
                      !i &&
                        (Math.min(t.width, t.height) > n ||
                          r === e.data.images.length - 1) &&
                        (i = t);
                    }),
                      !e.data.currentImage ||
                      (e.data.currentImage.url !== i.url &&
                        i.width > e.data.currentImage.width)
                        ? ((e.data.currentImage = i),
                          e.view.image.setAttribute(
                            "src",
                            e.data.currentImage.url
                          ),
          ...
          return (
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t &&
                    ...
                    (this.playing = !0),
                    this.view.element.classList.remove(
                      u.a.alias + "-popup-item-media-video-loading"
                    ),
                    this.view.element.classList.add(
                      u.a.alias + "-popup-item-media-video-loaded"
                    );
                },
              },
              {
              ...
              },
              {
                key: "toggleMuted",
                value: function (e) {
                  (this.popup.defaultVideoMute = this.view.video.muted =
                    void 0 !== e ? e : !this.view.video.muted),
                    this.view.video.muted
                      ? this.view.element.classList.remove(
                          u.a.alias + "-popup-item-media-video-unmuted"
                        )
                      : this.view.element.classList.add(
                          u.a.alias + "-popup-item-media-video-unmuted"
                        );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.view.element.addEventListener("click", function () {
                    t.view.element.classList.add(
                      u.a.alias + "-popup-item-media-video-loading"
                    ),
                      t.isMobileDevice && !t.playing
                        ? (t.play(), t.view.video.muted && t.toggleMuted())
                        : t.toggleMuted();
                  }),
                    window.addEventListener("resize", function () {
                      clearTimeout(e),
            ...
            O(n, null, [
              {
                key: "boot",
                value: function () {
                  return C(T(n), "boot", this).call(this);
                },
              },
              {
                key: "getAppName",
                ...
                value: function () {
                  ...
                  setTimeout(function () {
                    (window["".concat(e.meta.name, "Ready")] = !0),
                      window["on".concat(e.meta.name, "Ready")] &&
                        window["on".concat(e.meta.name, "Ready")](),
      ...
      function (e, t, n) {
        ...
        e.exports =
          ...
          r(function () {
            ...
            ? function (e, t) {
                for (
                  var n = c(e), r = arguments.length, l = 1, p = a.f, f = s.f;
                  r > l;
                  ...
                  for (
                    var d,
                      m = u(arguments[l++]),
                      h = p ? o(m).concat(p(m)) : o(m),
                      g = h.length,
                      v = 0;
                    g > v;

                  )
                    (d = h[v++]), (i && !f.call(m, d)) || (n[d] = m[d]);
                return n;
              }
            : l;
      },
        ...
        e.exports = function (e, t, n) {
          ...
          if (
            ...
            j ||
              ...
              (b.constructor = w)),
              (I || O) && (k("delete"), k("has"), h && k("get")),
              (O || L) && k(v),
              g && b.clear && delete b.clear;
          }
          return (
            (x[e] = w),
            i({ global: !0, forced: w != y }, x),
            d(w, e),
            g || n.setStrong(w, e, h),
            w
          );
      ...
      function (e, t, n) {
        (function (e, t) {
          ...
          n.n(i),
            (function (e) {
              e.Proxy ||
                ((e.Proxy = n(176)()), (e.Proxy.revocable = e.Proxy.revocable));
            })(
            ...
            n.n(v),
              (e.exports = function () {
                ...
                function i(e) {
                  if (null !== e && !n(e))
                    throw new TypeError(
                      "Object prototype may only be an Object or null: " + e
                    );
                }
                var r = Object,
                  o = Boolean(r.create) || !({ __proto__: null } instanceof r),
                  a =
                    r.create ||
                    (o
                      ? function (e) {
                          return i(e), { __proto__: e };
                        }
                      : function (e) {
                          if ((i(e), null === e))
                ...
                return (
                  ((e = function (u, l) {
                    if (
                      void 0 ===
                      (this && this instanceof e ? this.constructor : void 0)
                    )
                    ...
                    var y = l.get
                      ...
                      w = {};
                    r.getOwnPropertyNames(u).forEach(function (e) {
                      if (!((g || v) && e in m)) {
                        var t = r.getOwnPropertyDescriptor(u, e),
                          n = {
                            enumerable: Boolean(t.enumerable),
                            get: y.bind(u, e),
                            set: b.bind(u, e),
                          };
                        r.defineProperty(m, e, n), (w[e] = !0);
                      }
                    });
                    var x = !0;
                    if (g || v) {
                    ...
                    if (l.get || !x)
                      for (var S in u)
                        w[S] || r.defineProperty(m, S, { get: y.bind(u, S) });
                    return r.seal(u), r.seal(m), m;
                  }).revocable = function (n, i) {
                    return { proxy: new e(n, i), revoke: t };
                  }),
                  e
                );
              });
            ...
            u(e, [
              {
                ...
                value: function () {
                  ...
                  return new Promise(function (t, n) {
                    ...
                    "function" == typeof r.dependencies &&
                      (i = r.dependencies()),
                      s.a.load(i).then(
                        function () {
                          (e.app = r.boot()),
      ...
      function (e, t, n) {
        ...
        e.exports = function (e) {
          var t,
            ...
            w = 0;
          if (
            (y && (v = i(v, g > 2 ? arguments[2] : void 0, 2)),
            null == b || (h == Array && a(b)))
          )
            for (n = new h((t = s(m.length))); t > w; w++)
              (d = y ? v(m[w], w) : m[w]), c(n, w, d);
          else
            for (
              ...
              (d = y ? o(p, v, [l.value, w], !0) : l.value), c(n, w, d);
          return (n.length = w), n;
        };
      },
      function (e, t, n) {
          ...
          return (
            (function (e, t, n) {
            ...
            })(n, [
              {
                ...
                value: function (e) {
                  window.jQuery &&
                    (jQuery.fn[e.appName] = function (t) {
                      return (
                ...
                value: function (e) {
                  var t =
                      arguments.length > 1 && void 0 !== arguments[1]
                        ? arguments[1]
                        : {},
                    n = (e.meta.originalAlias || e.meta.alias).replace(
                      new RegExp("^eapps-"),
                      ""
                    ),
                    i = t.platform || {};
                  ["eapps", "esapps"].forEach(function (t) {
                    window[t] &&
                      window[t].apps.register(n, function () {
                        (this.whenReady = function (t) {
                          document.addEventListener(
                            "appReady.".concat(e.meta.name),
                            function () {
                              return t();
                            }
                          );
                          ...
                          (this.initWidget = function (t, n) {
                            i.settings && (n = Object.assign(n, i.settings)),
        ...
        var k = (function (e) {
          ...
          function n(e, i, r, o) {
            ...
            return (
              ...
              (a.language = new v.d()),
              (a.style = new v.e(i)),
              (a.analytics = new v.a(e.meta, r.widgetId)),
              a.root.setAttribute("id", "".concat(e.meta.alias, "-").concat(o)),
              (a.rootDefaultClasses = i.getAttribute("class")),
              a
            );
          }
          return (
            ...
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function (e) {
                  return e && 0 !== e.length
                    ? "en" === this.lang
                      ? this.parse(e, arguments)
                      : this.langDictionary.hasOwnProperty(e)
                      ? this.parse(this.langDictionary[e], arguments)
                      : e
                    : e;
                },
              },
              ...
              k(e, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      (e.body.innerHTML = this.template(this.props)),
                      (this.element = document.importNode(
                        e.body.children[0],
                        !0
                      )),
                  ...
                  value: function (e) {
                    ...
                    requestAnimationFrame(function () {
                      ...
                      (i.innerHTML = e),
                        ...
                        (t.styleElement.innerHTML = t
                          .getCSSRules(i.sheet.cssRules)
                          .join("\r"));
                    });
                  },
                },
                    ...
                    try {
                      for (r.s(); !(t = r.n()).done; ) {
                        ...
                        if (o instanceof CSSMediaRule) {
                          ...
                          var s =
                            this.id +
                            (this.isRootSelector(o.selectorText) ? "" : " ") +
                            o.cssText;
                          i && (s = "".concat(i, " {\r\t").concat(s, "\r}")),
                            n.push(s);
                        }
                      }
                    } catch (e) {
          ...
          return (
            (function (e, t, n) {
            ...
            })(e, [
              {
                ...
                value: function (e) {
                  return (this.app =
                    e.originalAlias || e.alias.replace("eapps-", ""));
                },
              },
              {
                key: "init",
                      ...
                      new (function () {
                        this.store = function (e) {
                          if (e.lifetime) {
                            ...
                            (i && !(i < n)) ||
                              (window.localStorage.setItem(t, n + e.lifetime),
                              console.log(
                                "analytics store",
                                e,
                                "lifetime: ".concat(e.lifetime, "s")
                              ));
                ...
                value: function (e) {
                  ...
                  this.available() &&
                    (window.addEventListener(
                      "scroll",
                      this.inViewPort.bind(this, e, 50)
                    ),
                    window.addEventListener(
                      "resize",
                      this.inViewPort.bind(this, e, 50)
      ...
      function (e, t, n) {
        ...
        var s = function e(t) {
          ...
          !(function (e, t) {
            ...
            setTimeout(function () {
              var e =
                  i.selector instanceof HTMLElement
                    ? i.selector
                    : document.querySelector(i.selector),
                t = '<a href="'
                  .concat(i.link, '" class="" target="_blank">')
                  .concat(i.text, "</a>"),
                r = document.implementation.createHTMLDocument("deactivation");
              (r.body.innerHTML = i.tpl ? i.tpl : t),
                (n.view = r.body.children[0]),
                n.view.setAttribute(
                  "style",
                  [
      ...
      function (e, t, n) {
        ...
        var y = function e(t, n) {
          ...
          var o =
              t.app.meta.originalAlias ||
              t.app.meta.alias.replace("eapps-", ""),
            ...
            w = { website_domain: l, app_alias: o },
          ...
          S.setAttribute("style", Object(m.a)(g(g({}, d.b), r))),
      ...
      function (e, t, n) {
        ...
        n(211)(i, { hmr: !0, transform: void 0, insertInto: void 0 }),
          i.locals && (e.exports = i.locals);
      },
      function (e, t, n) {
        (e.exports = n(210)(!1)).push([
          e.i,
        ...
        e.exports = function (e, t) {
          ...
          return (
            ...
            function (e) {
              ...
              for (e && l(p(e, t), t), o = 0; o < r.length; o++) {
                var s;
                if (0 === (s = r[o]).refs) {
        ...
        var Z = (function (e) {
          ...
          function n(e) {
            ...
            if (
              ...
              ((i = t.call(this, e)).settings = i.widget.tuner._rawSettings),
              (i.options = i.formatOptions(i.adaptOptions(i.settings))),
              (i.tuner = i.widget.tuner),
              (i.cache = new C.a(i.widget.app.meta.name)),
              (i.viewedPosts = []),
              i.root.hasAttribute("data-is"))
            ) {
              var r = i.tuner.get("source"),
                o = i.tuner.get("accessToken");
              if (!((Array.isArray(r) && 0 !== r.length) || o)) return W(i);
            }
            return i.init(), i;
          }
          return (
            (function (e, t, n) {
            ...
            })(n, [
              {
                ...
                value: function () {
                  (this.view = P.j.render(z.a)),
                    ...
                    this.tune(),
                    this.checkErrors() || (this.initLayout(), this.initTitle()),
                  ...
                  this.widget.style.init({
                    ...
                    props: Object.assign(
                      {},
                      {
                        ...
                        feedId: "#"
                          .concat(this.prefix, "-")
                          .concat(this.widget.id),
                        feedPrefix: ".".concat(this.prefix),
                        popupId: "#"
                          .concat(this.prefix, "-popup-")
                          .concat(this.widget.id),
                ...
                value: function () {
                  ...
                  this.widget.tuner.batchWatch(
                    ...
                    this.widget.tuner.batchWatch("widgetTitle", function () {
                      return e.widgetTitle.init(
                        A.a.links.formatInstagramAnchors(
                          e.widget.tuner.get("widgetTitle")
                        )
                      );
                    }),
                    ...
                    this.widget.tuner.batchWatch(
                      "width colorPostBg colorPostText colorPostLinks colorPostOverlayBg colorPostOverlayText colorSliderArrows colorSliderArrowsBg colorGridLoadMoreButton colorPopupOverlay colorPopupBg colorPopupText colorPopupLinks colorPopupFollowButton colorPopupCtaButton customCSS",
                      function () {
                        e.widget.style.update(
                          e.formatOptions(e.adaptOptions(e.settings))
                        );
                      }
                    );
                },
              },
              {
                ...
                value: function () {
                  ...
                  var t = this.tuner.get("layout"),
                    n = { slider: M.a, grid: _.a };
                  (this.layout = new n[t](this)),
                    !0 !== this.settings.showElfsightLogo ||
                      this.logo ||
                      (this.logo = new P.e(this.widget, this.root, !1, {
                        "margin-top": "20px!important",
                      })),
                    !0 !== this.settings.deactivate ||
                      this.deactivation ||
                      (this.deactivation = new P.d(this.widget, {
                        selector: this.root,
                        text: "Widget is deactivated<br>Visit Elfsight Apps",
                        link:
                          "https://apps.elfsight.com/panel/applications/instashow/?utm_source=websites&utm_medium=clients&utm_content=instagram-feed&utm_term=" +
              ...
              },
              {
                ...
                value: function () {
                  if (
                    ...
                    "null" === window.document.location.origin
                  ) {
              ...
              },
              {
                key: "initTitle",
                value: function () {
                  var e = A.a.links.formatInstagramAnchors(
                    this.settings.widgetTitle
                  );
                ...
                value: function () {
                  ...
                  if (!("businessHashtag" !== n || (r && o && a))) {
                    ...
                    return (
                      (u = r
                        ? o
                          ? "Please set a hashtag to display content"
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ("string" == typeof e && (console.error(e), (t = e)),
                    e.error)
                  ) {
                ...
                value: function (e) {
                  ...
                  return (
                    ...
                    [
                      ...
                      e.hasOwnProperty(t) &&
                        "string" == typeof e[t] &&
                        (e[t] = e[t].split(/[\s,;\|]+/).filter(function (e) {
                          return !!e;
                        }));
                    }),
                    e.hasOwnProperty("limit") &&
                      (e.limit = parseInt(e.limit, 10)),
                    e.hasOwnProperty("width") &&
                      ("auto" === e.width && (e.width = "100%"),
                      isNaN(e.width) ||
                        (e.width = parseInt(e.width, 10) + "px")),
                    e.hasOwnProperty("layout") &&
                      -1 === ["slider", "grid"].indexOf(e.layout) &&
                      (e.layout = D.a.layout),
                    e.hasOwnProperty("postTemplate") &&
                      -1 === ["tile", "classic"].indexOf(e.postTemplate) &&
                      (e.postTemplate = D.a.postTemplate),
                    e.hasOwnProperty("sliderAutoplay") &&
                      (e.sliderAutoplay = parseFloat(e.sliderAutoplay)),
                    e.hasOwnProperty("sliderSpeed") &&
                      (e.sliderSpeed = parseFloat(e.sliderSpeed)),
                    e.hasOwnProperty("cacheTime") &&
                      (e.cacheTime = parseInt(e.cacheTime, 10)),
                    e
                  );
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  for (var n in t) {
                    ...
                    e.hasOwnProperty(i) &&
                      (("info" !== i && "popupInfo" !== i) ||
                        (Array.isArray(e[i]) && (e[i] = e[i].join(" ")),
                        (e[i] = (e[i] || "")
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.tuner.get("debug") &&
                    e.push("".concat(this.prefix, "-debug")),
                    this.hasError &&
                      e.push("".concat(this.prefix, "-has-error")),
                ...
                value: function (e, t) {
                  ...
                  return new Promise(function (i, r) {
                    try {
                      var o, a;
                      n.isConnected() && t
                        ? ((o = n.db.transaction(["Items"], "readonly")),
                          ((a = o.objectStore("Items").get(e)).onsuccess =
                            function () {
                              var o = a.result;
                              o && o.date + t > Math.floor(Date.now() / 1e3)
                                ? i(o.result)
                                : (n.remove(e), r());
                            }),
                          (a.onerror = r))
          ...
          return (
            (function (e, t, n) {
            ...
            })(e, [
              {
                key: "show",
                value: function (e) {
                  this.parent && (this.parent.innerHTML = r()({ message: e }));
                },
              },
              {
                key: "hide",
                ...
                },
                {
                  ...
                  value: function (e) {
                    return e instanceof Date
                      ? e
                      : new Date(this.removeTimezone(e));
                  },
                },
                {
                  key: "removeTimezone",
                ...
                value: function (e, t) {
                  ...
                  return (
                    ...
                    (t
                      ...
                      : (n = e),
                    n.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + i)
                  );
                },
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return (
                    t.forEach(function (e) {
                      i = i.replace(
                        e,
                        '<span class="' + n + '-selected-text">' + e + "</span>"
                      );
                    }),
                    i
                  );
            ...
            (function (e, t, n) {
            ...
            })(n, [
              {
                ...
                value: function () {
                  var e = this;
                  return (
                    L(j(n.prototype), "init", this).call(this),
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.showLoader(),
                    L(j(n.prototype), "addView", this).call(this)
                  );
                },
              },
              {
                key: "createPage",
                value: function () {
                  var e = L(j(n.prototype), "createPage", this).call(this);
                  return (
                    e && e.view.element.classList.add("eui-slider-slide"), e
                  );
                },
              },
              {
                ...
                value: function () {
                  var e = this;
                  return L(j(n.prototype), "rebuildViews", this)
                    .call(this)
                    .then(function () {
      ...
      function (e, t, n) {
        var i = n(28),
          ...
          s = function (e) {
            return function (t) {
              for (
                var n, s = o(t), c = r(s), u = c.length, l = 0, p = [];
                u > l;

              )
                (n = c[l++]),
                  (i && !a.call(s, n)) || p.push(e ? [n, s[n]] : s[n]);
              return p;
            };
          };
        ...
        var C = (function (e) {
          ...
          function n(e) {
            ...
            return (
              ...
              ((i = t.call(this, e.widget)).widget = e),
              (i.tuner = e.tuner),
              (i.cache = e.cache),
              (i.error = e.error),
              (i.lang = e.language),
              ...
              },
              {
                ...
                value: function () {
                  (this.items = []),
                    ...
                    (this.actions =
                      this.tuner.get("callToActionButtons") || []);
                },
              },
              {
                key: "addItems",
                        ...
                        function (e) {
                          if (Array.isArray(e)) {
                            ...
                            e.forEach(function (e) {
                              if (
                                ("object" === I(t.actions) &&
                                  Object.entries(t.actions).length) ||
        ...
        var A = (function () {
          function e(t) {
            !(function (e, t) {
              ...
              (this.isAlternativeApi =
                !!this.apiUrl && this.apiUrl !== C.a.apiUrl),
              ...
              "object" === T(this.limit) &&
                Object.entries(this.limit).length &&
                (this.limit = 0),
            ...
            (function (e, t, n) {
            ...
            })(e, [
              {
                ...
                value: function () {
                  ...
                  (this.sourceScheme = Object(L.a)(this.source)),
                    this.sourceScheme &&
                      this.sourceScheme.length &&
                      this.sourceScheme.forEach(function (t) {
                        var n,
                          i = function (t) {
                        ...
                        switch (t.type) {
                          default:
                            break;
                          case "user":
                            n = new I.a(e, t.name, i);
                            break;
                          case "tag":
                            n = new P.a(e, t.name, i);
                            break;
                          case "location":
                            n = new j.a(e, t.name, i);
                            break;
                          case "specific_media_shortcode":
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  (e = e || this.maxCount),
                    ...
                    this.fetcherControllers.length ||
                      t.reject(
                        "Please set Instagram source (@username, #hashtag, location URL or post URL)."
                      ),
                    this.limit &&
                      (this.cursor >= this.limit
                        ? t.resolve([])
                        : (e = Math.min(this.limit - this.items.length, e)));
                  var i = [],
                    r = [];
                          ...
                          new Promise(function (e, i) {
                            return t.fetcher.fetch(o).then(
                              ...
                              function (i) {
                                ...
                                i &&
                                  i.meta &&
                                  i.meta.error_message &&
                                  (o = '<div class="eui-error-item"><strong>'
                                    .concat(t.source, ":</strong> ")
                                    .concat(i.meta.error_message, "</div>")),
                                  r.push(o),
                  ...
                  var o = function () {
                    if ((r.length, r.length === n.fetcherControllers.length))
                      return t.reject(r.join(" "));
                    var i = [];
                    n.fetcherControllers.forEach(function (e) {
                      ...
                      n.fetcherControllers.forEach(function (e) {
                        e.disabled || (e.stack = n.removeItems(e.stack, i)),
                          e.stack.length ||
                            e.fetcher.hasNext() ||
                            n.disableFetcherController(e);
                      }),
                      n.fillItemsUser(i).then(
                        function () {
                          (n.items = n.items.concat(i)),
                            (n.cursor += i.length),
                            n.disabledFetcherControllers.length !==
                              n.fetcherControllers.length ||
                              n.items.length ||
                              t.reject(
              ...
              },
              {
                ...
                value: function () {
                  var e = !0;
                  return (
                    this.limit && (e = this.cursor < this.limit),
                    e &&
                      this.fetcherControllers.some(function (e) {
                        return (
                          e.fetcher.hasNext() || !(!e.stack || !e.stack.length)
                        );
                      })
                  );
                },
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    (e && t) ||
                    ("classic" === this.tuner.get("postTemplate") &&
                      -1 !== this.tuner.get("postElements").indexOf("user"))
                  );
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, i) {
                    ...
                    e.forEach(function (e) {
                      e.user.id &&
                        (e.user.username &&
                          (t.filter.users[e.user.id] = e.user),
                        r.push(
                          new Promise(function (n) {
                            "object" === T(t.filter.users[e.user.id])
                              ? ((e.user = t.filter.users[e.user.id]), n())
                              : new O.a(t, e.code).fetch().then(
                                  function (i) {
                                    (t.filter.users[e.user.id] = i[0].user),
            ...
            splice: function (e, t) {
              ...
              if (
                (0 === b
                  ...
                  : 1 === b
                  ? ((n = 0), (i = v - y))
                  : ((n = b - 2), (i = h(m(o(t), 0), v - y))),
                v + n - i > 9007199254740991)
              )
                throw TypeError("Maximum allowed length exceeded");
              for (l = c(g, i), p = 0; p < i; p++)
                (f = y + p) in g && u(l, p, g[f]);
              if (((l.length = i), n < i)) {
                for (p = y; p < v - i; p++)
                  (d = p + n), (f = p + i) in g ? (g[d] = g[f]) : delete g[d];
                for (p = v; p > v - i + n; p--) delete g[p - 1];
              } else if (n > i)
                for (p = v - i; p > y; p--)
                  (d = p + n - 1),
                    (f = p + i - 1) in g ? (g[d] = g[f]) : delete g[d];
        ...
        var d = (function () {
          function e(t, n) {
            !(function (e, t) {
              ...
              (this.cacheTime = 3600),
              (this.debug =
                l.a.others.isLocalStorageAvailable() &&
                "true" === localStorage.getItem("eappsDebug")),
              this.debug &&
                ((this.cacheTime = 0),
                (window.requestCount = window.requestCount || 0),
            ...
            (function (e, t, n) {
                            ...
                            function (e) {
                              e && e.meta
                                ? (window.globalProfiler &&
                                  ...
                                  200 !== e.meta.code
                                    ? (t.log(!1, o, e, a),
                                      403 === e.meta.code || 404 === e.meta.code
                                        ? (t.cache.save(r, e), i(e))
                                        : i(e))
                                    : (t.log(!0, o, e, a),
                                      t.cache.save(r, e),
                                      n(e)))
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    this.accessToken
                      ? ((e.access_token = this.accessToken),
                        (t = this.apiUrl + this.path + "?" + this.param(e)))
                      : ((e.path = "/v1" + this.path),
        ...
        var y = (function (e) {
          ...
          function n(e, i, r) {
            return (
              ...
              t.call(this, e, "/locations/" + i + "/media/recent/", r)
            );
          }
          return n;
        })();
        ...
        var y = (function (e) {
          ...
          function n(e, i, r) {
            return (
              ...
              t.call(this, e, "/tags/" + i + "/media/recent/", r, "max_tag_id")
            );
          }
          return n;
        })();
                ...
                value: function (e) {
                  return e.map(function (e) {
                    ...
                    return {
                      ...
                      location: void 0,
                      tags: g,
                      user: { username: s, profile_picture: void 0 },
                      carousel_media: v,
                    };
                  });
                },
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (
                    ...
                    e + this.pointer <= this.items.length ||
                      !this.hasNextPage())
                  ) {
                      ...
                      this.request(r).then(
                        function (i) {
                          var r = i.data,
                            o = i.paging;
                          n.filter
                            .filterData(n.prepareData(r))
                            .then(function (i) {
                              (n.items = n.items.concat(i)),
                                n.limit &&
                                  (n.items = n.items.slice(0, n.limit)),
                                o &&
                                  o.next &&
                                  o.cursors &&
                                  o.cursors.after &&
                                  (!n.limit || n.items.length < n.limit) &&
                                  (n.nextCursor = o.cursors.after),
                                n.fetch(e, t);
                            });
                        },
                        function (e) {
                ...
                value: function (e) {
                  return e.map(function (e) {
                    ...
                    return {
                      ...
                      likes: { count: l, data: void 0 },
                      comments: { count: p, data: void 0 },
                      created_time: Date.parse(c) / 1e3,
                      link: n,
                      type: m,
                      location: void 0,
                      ...
                      user: { username: s, profile_picture: void 0 },
                      followButtonLink: s
                        ? "'https://www.instagram.com/'".concat(s)
                        : s,
                      carousel_media: b,
                    };
                  });
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return this.client.get(
                    "".concat(this.account.value, "/media"),
                    e
                  );
                },
              },
            ...
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  return new Promise(function (t, n) {
                    var i = { user_id: e.account.value, q: e.hashtag };
                    e.client.get("ig_hashtag_search", i).then(
                      function (n) {
                        var i = n.data;
                      ...
                      function (t) {
                        ...
                        i &&
                          24 === i.code &&
                          n('Hashtag "#'.concat(e.hashtag, '" doesnt exist')),
                          n(i.message);
                      }
                    );
                  });
                          ...
                          n.filter
                            ...
                            .then(function (i) {
                              (n.items = n.items.concat(i)),
                                n.items &&
                                  0 === n.items.length &&
                                  n.dependencies.widget.showError(
                                    'No posts found by hashtag "#'.concat(
                                      n.hashtag,
                                      '"'
                                    )
                                  ),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return new Promise(function (n, i) {
                    e.client
                      .get("".concat(e.hashtagId, "/recent_media"), t)
                      .then(function (e) {
                        if (e.error) return i(e);
                        n(e);
                      }, i);
                  });
                },
          ...
          ae = (function (e) {
            ...
            function n(e, i) {
              ...
              !(function (e, t) {
                ...
                ((r = t.call(this, e.widget)).tuner = e.tuner),
                (r.popup = e.layout.popup),
                (r.language = e.language);
              var o = { tile: A.a, classic: _.a };
              return (
                (r.templateName = r.tuner.get("postTemplate")),
                (r.template = o[r.templateName]),
                (r.elements = r.tuner.get("postElements")),
                (r.data = r.formatData(i)),
              ...
              (function (e, t, n) {
              ...
              })(n, [
                {
                  ...
                  value: function () {
                    (this.view = this.createElement()),
                      (this.links = this.view.element.querySelectorAll(
                        "." + T.a.alias + "-posts-item-link"
                      )),
                ...
                },
                {
                  ...
                  value: function () {
                    return (
                      ...
                      (this.parts.date = B()(this.data)),
                      (this.parts.instagramLink = U()(this.data)),
                      (this.parts.image = H()(this.data)),
                      (this.parts.likesCount = G()(this.data)),
                      (this.parts.commentsCount = J()(this.data)),
                      (this.parts.share = q()(this.data)),
                      (this.parts.text = $()(this.data)),
                      j.j.render(this.template, this.data)
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    this.view.text &&
                      ((this.data.text =
                        O.a.text.removeLineBreaks(this.data.text) || ""),
                      (this.view.text.innerHTML = this.data.text),
                      (this.textClone = this.view.text.cloneNode(!0)),
                      this.textClone.classList.add(
                        T.a.alias + "-posts-item-text-clone"
                      ),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      (t.code = e.code),
                      (t.text =
                        e.caption && e.caption.text ? e.caption.text : ""),
                      (t.spacedText = O.a.text.nl2br(
                        O.a.links.formatInstagramAnchors(t.text)
                      )),
                      e.images &&
                        ((t.images = []),
                        [
                      ...
                      (t.likesCountFormatted = t.likesCount
                        ? O.a.numbers.formatNumber(t.likesCount, !0)
                        : void 0),
                      (t.showAllComments = t.commentsCount > 10),
                      (t.createdTime = C.a.formatDate(
                        e.created_time,
                        this.language
                      )),
                      (t.link = e.link),
                      ...
                      e.user &&
                        ((t.user = {}),
                        e.user.username &&
                          ((t.user.username = e.user.username),
                          (t.followButtonLink =
                            (O.a.others.isMobileDevice()
                              ? "instagram://user?username="
                              : "https://www.instagram.com/") +
                            e.user.username)),
                        e.user.profile_picture &&
                          (t.user.profilePicture = e.user.profile_picture),
                        e.user.full_name &&
                          (t.user.fullName = e.user.full_name)),
                      e.videos &&
                        (t.videoUrl = e.videos.standard_resolution.url),
                      e.carousel_media &&
                        ((t.carousel = []),
                        (e.carousel_media || []).forEach(function (n) {
                          ...
                          n.videos &&
                            (i.videoUrl = n.videos.standard_resolution.url),
                            [
                              "thumbnail",
                              "low_resolution",
                              "standard_resolution",
                              ...
                              n.images
                                ? n.images[t] && i.images.push(n.images[t])
                                : e.images[t] && i.images.push(e.images[t]);
                            }),
                            t.carousel.push(i);
                        })),
                      (t.labels = {
                      ...
                      e.comments &&
                        ...
                        (t.commentsCountFormatted = O.a.numbers.formatNumber(
                          e.comments.count,
                          !0
                        )),
                        (t.comments = (e.comments.data || []).slice(0, 5)),
                        t.comments.forEach(function (e) {
                          e.text = O.a.links.formatInstagramAnchors(e.text);
                        })),
                      t
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    this.data.images.forEach(function (i, r) {
                      !n &&
                        (Math.min(i.width, i.height) > t ||
                          r === e.data.images.length - 1) &&
                        (n = i);
                    }),
                      (!this.data.currentImage ||
                        (this.data.currentImage.url !== n.url &&
                          n.width > this.data.currentImage.width)) &&
                        ((this.data.currentImage = n),
                        this.view.element.classList.remove(
                          T.a.alias + "-posts-item-loaded"
                        ),
                        this.data.currentImage.url &&
                        this.data.currentImage.url.includes(".mp4")
                          ? ((this.view.image.style.display = "none"),
                              ...
                              function (t) {
                                ...
                                n.videoHeight / i > 1
                                  ? e.view.element.classList.add(
                                      T.a.alias + "-posts-item-image-portrait"
                                    )
                                  : e.view.element.classList.add(
                                      T.a.alias + "-posts-item-image-landscape"
                                    ),
                                  e.view.element.classList.add(
                                    T.a.alias + "-posts-item-loaded"
                                  );
                          ...
                          : ((this.view.video.style.display = "none"),
                            this.view.image.setAttribute(
                              "src",
                              this.data.currentImage.url
                            ),
                            this.view.image.setAttribute(
                              "alt",
                              "".concat(this.data.text.slice(0, 77), "...")
                            ),
                            this.view.image.addEventListener(
                              "load",
                              function (t) {
                                var n = t.target,
                                  i = n.naturalWidth;
                            ...
                            this.view.image.addEventListener(
                              ...
                              function () {
                                e.view.image.setAttribute(
                                  "src",
                                  e.data.images[e.data.images.length - 1].url
                                ),
                                  e.view.image.addEventListener(
                                    "load",
                                    function () {
                                      e.view.element.classList.add(
                                        T.a.alias + "-posts-item-loaded"
                ...
                },
                {
                  ...
                  value: function () {
                    this.view.text &&
                      this.view.textClone &&
                      (Math.floor(this.view.text.offsetHeight) <
                      Math.floor(this.view.textClone.offsetHeight)
                        ? this.view.text.parentElement.classList.add(
                            T.a.alias + "-posts-item-content-cropped"
                          )
                        : this.view.text.parentElement.classList.remove(
                            T.a.alias + "-posts-item-content-cropped"
                          ));
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      (e.header =
                        e.user ||
                        (e.instagramLink && "none" !== this.elements)),
                      (e.likesCount =
                        e.likesCount &&
                      ...
                      (e.counters =
                        e.likesCount ||
                        (e.commentsCount && "none" !== this.elements)),
                      (e.meta =
                        e.counters || (e.share && "none" !== this.elements)),
                      (e.overlay =
                        e.counters || (e.text && "none" !== this.elements)),
                      e
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    "none" === n
                      ? ee(this.links).forEach(function (e) {
                          return e.classList.add(
                            "".concat(t.prefix, "-posts-item-link-disabled")
                          );
                        })
                      : ee(this.links).forEach(function (e) {
        ...
        i(
          {
            target: "Array",
            proto: !0,
            forced: !n(43)("indexOf", { ACCESSORS: !0, 1: 0 }),
          },
          {
            includes: function (e) {
              return r(this, e, arguments.length > 1 ? arguments[1] : void 0);
      ...
      function (e, t, n) {
        var i = n(1),
          ...
          o = n(36);
        i(
          { target: "String", proto: !0, forced: !n(244)("includes") },
          {
            includes: function (e) {
            ...
            (function (e, t, n) {
            ...
            })(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  if (s >= 604800) {
                    var u = { month: "long", day: "numeric" };
                    return (
                      c.year < o.getFullYear() && (u.year = "numeric"),
                      i.a.dates.castDate(n).toLocaleDateString(t.lang, u)
                    );
                  }
      ...
      function (e, t) {
        e.exports = function (e) {
          var t =
            '<div class="eapps-instagram-feed-posts-item-template-tile eapps-instagram-feed-posts-item eapps-instagram-feed-posts-item-type-' +
            e.type +
            '">\r\n    <a class="eapps-instagram-feed-posts-item-link" href="' +
            e.link +
            '" eapps-link="link" target="_blank" rel="nofollow">\r\n        <div class="eapps-instagram-feed-posts-item-media">\r\n            ' +
            e.parts.image +
            "\r\n        </div>\r\n\r\n        ";
          return (
            e.displaying.overlay &&
              ((t +=
                '\r\n            <div class="eapps-instagram-feed-posts-item-overlay" eapps-link="overlay">\r\n                <div class="eapps-instagram-feed-posts-item-content" eapps-link="content">\r\n                    '),
              e.displaying.counters &&
                ((t +=
                  '\r\n                        <div class="eapps-instagram-feed-posts-item-counters">\r\n                            '),
                e.displaying.likesCount &&
                  (t +=
                    "\r\n                                " +
                    e.parts.likesCount +
                    "\r\n                            "),
                (t += "\r\n\r\n                            "),
                e.displaying.commentsCount &&
                  (t +=
                    "\r\n                                " +
      ...
      function (e, t) {
        e.exports = function (e) {
          var t =
            '<div class="eapps-instagram-feed-posts-item-template-classic eapps-instagram-feed-posts-item eapps-instagram-feed-posts-item-type-' +
            e.type +
            '">\n    ';
          return (
            e.displaying.header &&
            ...
            (t +=
              ...
              "\n        </a>\n    </div>\n\n    "),
            e.displaying.meta &&
              (e.displaying.likesCount || e.displaying.commentsCount) &&
              ((t +=
          ...
          return (
            e.user.profilePicture &&
              (t +=
                ...
                '" title="' +
                e.user.username +
                '" target="_blank" rel="nofollow">\n            <img class="eapps-instagram-feed-posts-item-user-image" src="' +
                e.user.profilePicture +
                '" alt="' +
                e.user.username +
                '">\n        </a>\n    </div>\n'),
      ...
      function (e, t) {
        e.exports = function (e) {
          return (
            '<div class="eapps-instagram-feed-posts-item-date">' +
            e.createdTime +
            "</div>"
          );
        };
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (this.showing = !0),
                    ...
                    this.opener.widget.layout &&
                      this.opener.widget.layout.slider &&
                      this.opener.widget.layout.slider.autoplay &&
                      this.opener.widget.layout.slider.disableAutoplay(),
                    this.renderItems();
                  var t = 0;
                  this.items.forEach(function (n, i) {
                    ...
                    this.view.element.classList.add(
                      d.a.alias + "-popup-visible"
                    ),
                    this.isMobileDevice &&
                      this.view.element.classList.add(
                        d.a.alias + "-popup-mobile"
                      ),
                    this.opener.widget.analytics.available() &&
                      this.opener.widget.analytics.store("popup-opened", 1);
                },
              },
              {
                key: "renderItems",
                  ...
                  null !== t && this.moveToItem(t),
                    this.currentItemIndex !== n &&
                      ...
                      this.currentItem.init().then(function () {
                        e.isVideo() &&
                          !e.isMobileDevice &&
                          e.currentItem.media.play();
                      }),
                      this.deepLinking &&
                        (window.location.hash =
                          "#!is" + this.id + "/$" + this.currentItem.data.code),
                      this.initForwardItems(),
                      this.currentItem.onInitCallback(),
                      this.opener.widget.analytics.available() &&
                        p.a.others.inViewPort(
                          this.currentItem.view.element,
                          20
                        ) &&
                        (this.opener.widget.viewedPosts.indexOf(
                          this.currentItem.data.code
                        ) + 1 ||
                          (this.opener.widget.viewedPosts.push(
                            this.currentItem.data.code
                          ),
                          this.opener.widget.analytics.store(
                            "posts-viewed",
                            1
                          ))));
                },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  var n = this.items.slice(
                    ...
                    this.currentItemIndex + 1 + this.forwardItemsCount
                  );
                  return (
                    n.length < this.forwardItemsCount
                      ? this.loadItems().then(function (i) {
              ...
              },
              {
                ...
                value: function () {
                  this.items.forEach(function (e) {
                    e.media &&
                      e.media.isVideo &&
                      !e.media.view.video.paused &&
                      (e.media.pause(), (e.playing = !1));
                  });
                },
              },
              {
                ...
                value: function () {
                  this.pauseVideos(),
                    ...
                    this.opener.widget.layout.slider &&
                      (this.opener.widget.layout.slider.updateSlides(),
                      this.opener.widget.layout.slider.checkLoopNeed(),
                      this.opener.widget.layout.slider.updateArrows(),
                      this.opener.widget.layout.slider.autoplay &&
                        this.opener.widget.layout.slider.enableAutoplay());
                },
              },
              {
                key: "isShowing",
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    this.currentItem.media.isVideo
                  );
                },
              },
              {
                  ...
                  p.a.others.isLocalStorageAvailable() &&
                    (this.scrollIndicatorAlreadyShown =
                      window.localStorage.getItem(
                        d.a.alias + "-popup-scroll-indicator-already-shown"
                      )),
                    this.scrollIndicatorAlreadyShown ||
                      (this.view.scrollIndicator.classList.add(
                        d.a.alias + "-popup-scroll-indicator-visible"
                      ),
                      setTimeout(function () {
                        e.view.scrollIndicator.classList.remove(
                          d.a.alias + "-popup-scroll-indicator-visible"
                        ),
                          p.a.others.isLocalStorageAvailable() &&
                            window.localStorage.setItem(
                              d.a.alias +
                                "-popup-scroll-indicator-already-shown",
                              !0
                            );
                      }, 3800));
                },
              },
              {
                ...
                value: function () {
                  ...
                  this.view.wrapper.addEventListener("click", function (t) {
                    t.target.closest("." + d.a.alias + "-popup-inner") ||
          ...
          j = (function () {
            function e(t, n) {
              !(function (e, t) {
                ...
                (this.rawData = {}),
                (this.sourceType && "legacy" !== this.sourceType) ||
                  this.tuner.get("accessToken") ||
                  (this.fetcher = new h.a(t.opener, this.data.code)),
                (this.data.labels = {
                  viewOnInstagram: this.language.get("View on Instagram"),
            ...
            return (
              (function (e, t, n) {
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      var n = function () {
                        ...
                        var t = v.a.numbers.formatNumber(
                          e.data.likesCount - 1,
                          !0
                        );
                        e.data.likesCount &&
                          (e.data.likes && e.data.likes[0]
                            ? e.data.likesCount > 1
                              ? (e.data.labels.likedBy = e.language.get(
                                  "Liked by %1 and %2 others",
                                  '<strong><a href="https://www.instagram.com/'
                                    .concat(
                                      e.data.likes[0].username,
                                      '" target="_blank" rel="nofollow">'
                                    )
                                    .concat(
                                      e.data.likes[0].username,
                            ...
                            : (e.data.labels.likedBy = e.language.get(
                                "%1 likes",
                                v.a.numbers.formatNumber(e.data.likesCount, !0)
                              ))),
                          (e.data.labels.viewAllComments = e.language.get(
                            "View all %1 comments",
                            e.data.commentsCountFormatted
                          )),
                          (e.data.displaying = e.getDisplaying()),
                          e.initMedia().then(function () {
                            e.view.element.classList.add(
                              x.a.alias + "-popup-item-loaded"
                            ),
                              (e.loaded = !0),
                              e.initDef.resolve();
                          });
                        ...
                        ["header", "likes", "text", "comments"].forEach(
                          function (t) {
                            var i = n.element.querySelector(
                                "." + x.a.alias + "-popup-item-" + t
                              ),
                              r = e.view.element.querySelector(
                                "." + x.a.alias + "-popup-item-" + t
                              );
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this;
                    !this.callToActionHighlighted &&
                      this.data.callToAction &&
                      ((this.callToActionHighlighted = !0),
                      setTimeout(function () {
                        e.view.cta.classList.add(
                          x.a.alias + "-popup-item-cta-highlighted"
                        );
                      }, 3e3));
                  },
                },
                ...
                },
                {
                  key: "initMedia",
                  value: function () {
                    var e = new { image: y.a, video: b.a, carousel: w.a }[
                      this.data.type
                    ](this, this.data);
                    return (
                      e.view.appendTo(this.view.media),
                      "carousel" === this.data.type
                        ? (this.mediaCarousel = e)
                        : (this.media = e),
                      e.init()
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    return new Promise(function (t) {
                      e.enoughData()
                        ? t()
                        : e.fetcher.fetch().then(function (n) {
                            n &&
                              n.length &&
                              ((e.rawData = e.formatData(n[0])), t());
                          });
                    });
                  },
                },
                {
                  ...
                  value: function () {
                    var e = !!this.data.user.username,
                      t =
                        0 === this.data.commentsCount ||
                        !(!this.data.comments || !this.data.comments.length),
                      n =
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      (t.text =
                        e.caption && e.caption.text ? e.caption.text : ""),
                      (t.spacedText = v.a.text.nl2br(
                        v.a.links.formatInstagramAnchors(t.text)
                      )),
                      e.comments &&
                        ((t.comments = (e.comments.data || []).slice(0, 5)),
                        t.comments.forEach(function (e) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      (e.followButton = !!this.data.followButtonLink),
        ...
        var O = (function () {
          function e(t, n) {
            ...
            !(function (e, t) {
              ...
              n.carousel &&
                n.carousel.length &&
                n.carousel.forEach(function (e) {
                  var t = new { image: b.a, video: w.a }[e.type](
                      i.popupItem,
                      e
                    ),
                  ...
                  (r.className =
                    x.a.alias + "-popup-item-media-carousel-pagination-item"),
                    t.view.appendTo(n),
                    i.view.inner.appendChild(n),
                    i.view.pagination.appendChild(r),
                    i.items.push(t);
                }),
              setTimeout(function () {
                i.fitItems();
            ...
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (this.view.wrapper.style.transitionDuration = t
                    ? "0ms"
                    : "400ms"),
                    (this.view.wrapper.style.transform =
              ...
              },
              {
                ...
                value: function () {
                  this.hasPrev()
                    ? this.view.arrowPrev.classList.remove(
                        x.a.alias + "-popup-item-media-carousel-arrow-disabled"
                      )
                    : this.view.arrowPrev.classList.add(
                        x.a.alias + "-popup-item-media-carousel-arrow-disabled"
                      ),
                    this.hasNext()
                      ? this.view.arrowNext.classList.remove(
                          x.a.alias +
                            "-popup-item-media-carousel-arrow-disabled"
                        )
                      : this.view.arrowNext.classList.add(
                          x.a.alias +
                            "-popup-item-media-carousel-arrow-disabled"
                        );
                },
              },
              {
                key: "fitPagination",
                value: function () {
                  var e = this.view.pagination.querySelectorAll(
                    "." +
                      x.a.alias +
                      "-popup-item-media-carousel-pagination-item"
                  );
                  L(e).forEach(function (e) {
                    e.classList.remove(
                      x.a.alias +
                        "-popup-item-media-carousel-pagination-item-active"
                    );
                  }),
                    e[this.currentItemIndex].classList.add(
                      x.a.alias +
                        "-popup-item-media-carousel-pagination-item-active"
                    );
                },
              },
              {
                ...
                value: function () {
                  var e;
                  (e = this.currentItem.isVideo
                    ? this.currentItem.view.video.clientHeight
                    : this.currentItem.view.image.clientHeight),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  window.addEventListener("resize", function () {
                    ...
                    L(
                      this.view.pagination.querySelectorAll(
                        "." +
                          x.a.alias +
                          "-popup-item-media-carousel-pagination-item"
                      )
      ...
      function (e, t) {
        e.exports = function (e) {
          var t =
            '<div class="eapps-instagram-feed-popup-item">\r\n    <div class="eapps-instagram-feed-popup-item-inner">\r\n        ';
          return (
            (e.displaying.user ||
              e.displaying.followButton ||
              e.displaying.instagramLink) &&
              ((t +=
              ...
              e.user &&
                ...
                (t +=
                  "\r\n                        </div>\r\n                    </div>\r\n                ")),
              (t += "\r\n\r\n                "),
              (e.displaying.followButton || e.displaying.instagramLink) &&
                ((t +=
            ...
            e.callToAction &&
              (t +=
                ...
                e.callToAction.buttonLink +
                '" class="eapps-instagram-feed-popup-item-cta-button" target="_blank" rel="nofollow">\r\n                    <span class="eapps-instagram-feed-popup-item-cta-button-label">' +
                e.callToAction.buttonLabel +
                '</span>\r\n\r\n                    <svg class="eapps-instagram-feed-popup-item-cta-button-icon" viewBox="0 0 6 10">\r\n                        <path d="M5.71,4.286L1.727,0.302c-0.39-0.392-1.023-0.392-1.414,0c-0.39,0.39-0.39,1.023,0,1.414L3.59,4.992\r\n                        L0.289,8.284c-0.39,0.39-0.39,1.025,0,1.415c0.39,0.39,1.023,0.39,1.414,0l4.008-4C6.101,5.309,6.101,4.675,5.71,4.286z"></path>\r\n                    </svg>\r\n                </a>\r\n            </div>\r\n        '),
            (t += "\r\n\r\n        "),
            e.displaying.content &&
              ((t +=
              ...
              e.displaying.text &&
                ...
                e.user.username &&
                  (t +=
                    ...
                    '" title="' +
                    e.user.username +
                    '" class="eapps-instagram-feed-popup-item-text-author" target="_blank" rel="nofollow">\r\n                                ' +
                    e.user.username +
                    "\r\n                            </a>\r\n                        "),
                (t +=
                  "\r\n\r\n                        " +
              ...
              e.displaying.date &&
                (t +=
                  '\r\n                    <div class="eapps-instagram-feed-popup-item-date">' +
                  e.createdTime +
                  "</div>\r\n                "),
              (t += "\r\n            </div>\r\n        ")),
            (t +=
      ...
      function (e, t) {
        e.exports = function (e) {
          return (
            '<div class="eapps-instagram-feed-popup eapps-instagram-feed eapps-widget" id="' +
            e.id +
            '">\r\n    <div class="eapps-instagram-feed-popup-mobile-panel">\r\n        <div class="eapps-instagram-feed-popup-mobile-panel-title">' +
            e.mobilePanelTitle +
          ...
          function e(t) {
            !(function (e, t) {
              ...
              (this.view = s.j.render(p.a, {
                labels: { redLike: this.language.get("Liked a while ago") },
              })),
              this.watch();
          }
          return (
            (function (e, t, n) {
              ...
              },
              {
                ...
                value: function () {
                  !this.alreadyShown &&
                    this.checkInViewport(this.layout.view.element) &&
                    this.run();
                },
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    i = new Date().getTime();
                  if (
                    (c.a.others.isLocalStorageAvailable() &&
                      ((this.prevShowTime = parseInt(
                        window.localStorage.getItem(
                          u.a.alias + "-red-like-time"
                        ),
                        10
                      )),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this.view.appendTo(e.view.redLikeContainer),
                    setTimeout(function () {
                      t.view.element.classList.add(
                        u.a.alias + "-posts-item-red-like-visible"
                      );
                    }, 300),
                    setTimeout(function () {
                      t.hide();
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = null;
                  return (
                    this.layout.pages.forEach(function (n) {
        ...
        var w = (function (e) {
          ...
          function n(e, i, r) {
            ...
            return (
              ...
              ((o = t.call(this, i, r)).widget = e.widget),
              (o.layout = e),
              (o.options = r),
            ...
            (function (e, t, n) {
            ...
            })(n, [
              {
                ...
                value: function () {
                  return (
                    ...
                    (this.options.loop && this.slides.length > 1) ||
                    this.fetherHasNext
                  );
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n) {
                    t.translating ||
                      ((t.fetherHasNext = t.layout.posts.fetcher.hasNext()),
                      t.fetherHasNext && t.isEnd()
                        ? t.layout.addView().then(function () {
                            t.updateSlides(), n();
                          })
                        : n(),
                      t.hasNext() && (t.currentIndex++, t.realIndex++),
              ...
              },
              {
                key: "checkLoopNeed",
                value: function () {
                  this.layout.posts.fetcher.hasNext() ||
                    this.loop ||
                    !this.options.loop ||
                    this.enableLoop();
                },
          ...
          P = (function () {
            function e(t, n) {
              !(function (e, t) {
                ...
                (this.options = Object.assign({}, O, n));
            }
            return (
              (function (e, t, n) {
                t && j(e.prototype, t);
              })(e, [
                {
                  ...
                  value: function () {
                    (this.inner =
                      this.element.querySelector(".eui-slider-inner")),
                      (this.isRtl =
                        "rtl" === getComputedStyle(this.inner).direction),
                      (this.realSlides =
                        this.element.querySelector(".eui-slider-slide")),
                      (this.arrowPrev = this.isRtl
                        ? this.element.querySelector(".eui-slider-arrow-next")
                        : this.element.querySelector(".eui-slider-arrow-prev")),
                      (this.arrowNext = this.isRtl
                        ? this.element.querySelector(".eui-slider-arrow-prev")
                        : this.element.querySelector(".eui-slider-arrow-next")),
                      (this.dotsContainer =
                        this.element.querySelector(".eui-slider-dots")),
                      (this.dotsInner = this.element.querySelector(
                        ".eui-slider-dots-inner"
                      )),
                      (this.currentIndex = 0),
                      (this.realIndex = 0),
                      ...
                      (this.allowClick = !0),
                      (this.paginationType =
                        ("classic" === this.options.paginationType ||
                          "numbers" === this.options.paginationType) &&
                        this.options.paginationType),
                      this.updateSlides(),
                      this.updateArrows(),
                      (this.speed = parseInt(this.options.speed, 10)),
                      (this.autoplayDelay = parseInt(
                ...
                },
                {
                  key: "updateArrows",
                  value: function () {
                    this.options.arrows && this.hasPrev()
                      ? this.arrowPrev.classList.add("eui-slider-arrow-enabled")
                      : this.arrowPrev.classList.remove(
                          "eui-slider-arrow-enabled"
                        ),
                      this.options.arrows && this.hasNext()
                        ? this.arrowNext.classList.add(
                            "eui-slider-arrow-enabled"
                          )
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return new Promise(function (n, i) {
                      t.translateStart(),
                        e
                          ? ((t.inner.style.transform = "translate3d("
                              .concat(t.isRtl ? "+" : "-")
                              .concat(100 * t.realIndex, "%,0,0)")),
                            (t.inner.style.transitionDuration = "0ms"),
                            t.translateEnd(),
                            n())
                          : ((t.translating = !0),
                            t.inner.classList.add(
                              "eui-slider-inner-translating"
                            ),
                            (t.inner.style.transform = "translate3d("
                              .concat(t.isRtl ? "+" : "-")
                              .concat(100 * t.realIndex, "%,0,0)")),
                ...
                },
                {
                  key: "getCoordinates",
                  value: function (e) {
                    return k.a.others.isMobileDevice()
                  ...
                  value: function () {
                    ...
                    if (
                        ...
                        n = function (t) {
                          if (e.isTouched) {
                            ...
                            (n = r[0]),
                              (i = r[1]),
                              (e.diffX =
                                ((e.startX - n) / e.sliderWidth) * 100),
                              (e.diffY =
                                ((e.startY - i) / e.sliderHeight) * 100),
                              Math.abs(e.diffX) > e.minDiff &&
                                !e.verticalMove &&
                                (e.horizontalMove = !0),
                              Math.abs(e.diffY) > e.minDiff &&
                                !e.horizontalMove &&
                                (e.verticalMove = !0),
                              e.verticalMove ||
                                (e.loop ||
                                  (((!e.realIndex && e.diffX < 0) ||
                                    (e.realIndex === e.realSlides.length &&
                                      e.diffX > 0)) &&
                                    (e.diffX /= 2)),
                                (e.inner.style.transform =
                                  "translate3d(" +
                                  (100 * -e.realIndex - e.diffX) +
                                  "%,0,0)"),
                                t.preventDefault());
                          }
                        },
                        i = function () {
                          if (e.isTouched) {
                            if (
                              ...
                              return;
                            e.horizontalMove && e.diffX <= -e.minDiff
                              ? e.movePrev()
                              : e.horizontalMove && e.diffX >= e.minDiff
                              ? e.moveNext()
                              : e.translate();
                      ...
                      this.inner.addEventListener(
                        ...
                        function (t) {
                          !e.allowClick &&
                            (Math.abs(e.diffX) > 1 || Math.abs(e.diffY) > 1) &&
                            (t.preventDefault(),
                            t.stopPropagation(),
                        ...
                        document.body.addEventListener("mouseup", i.bind(this)),
                        document.body.addEventListener(
                          "touchend",
                          i.bind(this)
                        );
                    ...
                    this.element.addEventListener("mouseenter", function () {
                      ...
                      this.arrowPrev.addEventListener(
                        "click",
                        this.movePrev.bind(this, !1)
                      ),
                      this.arrowPrev.addEventListener(
                        "touchend",
                        this.movePrev.bind(this, !1)
                      ),
                      this.arrowNext.addEventListener(
                        "click",
                        this.moveNext.bind(this, !1)
                      ),
                      this.arrowNext.addEventListener(
                        "touchend",
                        this.moveNext.bind(this, !1)
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (
                      !(
                        (!this.dotsInner && this.slides.length < 2) ||
                        !this.paginationType
                      )
                    ) {
                      (this.dotsInner.innerHTML = ""),
                        ...
                        this.dotsContainer.classList.add(
                          "eui-slider-dots-" + this.paginationType
                        );
                      for (
                        var t = function (t) {
                    ...
                    if (this.dots.length) {
                      ...
                      this.loop &&
                        ...
                        this.isRealEnd()
                          ...
                          : (this.isBeginning() || t < 0) && (t = 0));
                      var n = this.dots[0].offsetWidth,
                        i = getComputedStyle(this.dots[0]),
                        r =
                          n + parseInt(i.marginLeft) + parseInt(i.marginRight);
                      this.dots.forEach(function (n) {
                        (n.className = "eui-slider-dots-item"),
                          "classic" === e.paginationType &&
                            (n.style.left =
                              e.dotsInner.offsetWidth / 2 -
                              (t + 1) * r +
                              r / 2 +
                              "px");
                      }),
                        this.dots[t] &&
                          this.dots[t].classList.add(
                            "eui-slider-dots-item-active"
                          ),
                        this.dots[t - 1] &&
                          (this.dots[t - 1].classList.add(
                            "eui-slider-dots-item-active-prev"
                          ),
                          this.dots[t - 2] &&
                            this.dots[t - 2].classList.add(
                              "eui-slider-dots-item-active-prev-prev"
                            )),
                        this.dots[t + 1] &&
                          (this.dots[t + 1].classList.add(
                            "eui-slider-dots-item-active-next"
                          ),
                          this.dots[t + 2] &&
                            this.dots[t + 2].classList.add(
                              "eui-slider-dots-item-active-next-next"
                            ));
                    }
                  },
                },
                {
                  ...
                  value: function () {
                    !this.isHovered &&
                      ...
                      ((this.autoplayPaused = !1), this.tickAutoplay());
                  },
                },
                {
                  key: "stopAutoplay",
                ...
                },
                {
                  ...
                  value: function () {
                    this.loop &&
                      (this.isRealBeginning() &&
                        ((this.currentIndex = this.slides.length - 1),
                        (this.realIndex =
                          this.realSlides.length - 1 < 1
                            ? 1
                            : this.realSlides.length - 2),
                        this.translate(!0)),
                      this.isRealEnd() &&
                        ((this.realIndex = 1),
                        (this.currentIndex = 0),
                ...
                },
                {
                  ...
                  value: function () {
                    var e;
                    (this.realSlides =
                      this.element.querySelectorAll(".eui-slider-slide")),
                      (this.slides = ((e = this.realSlides),
                      (function (e) {
                        if (Array.isArray(e)) return I(e);
                      })(e) ||
                        (function (e) {
            ...
            (function (e, t, n) {
            ...
            })(n, [
              {
                ...
                value: function (e) {
                  return (
                    !e &&
                    (S(I(n.prototype), "init", this).call(this),
                    this.watch(),
                    this.addView())
                  );
                },
                ...
                value: function () {
                  var e = this,
                    t =
                      !(arguments.length > 0 && void 0 !== arguments[0]) ||
                      arguments[0];
                  return S(I(n.prototype), "addView", this)
                    .call(this, t)
                    .then(function () {
                      e.posts.fetcher.hasNext()
                        ? (e.view.loadMore.classList.add(
                            y.a.alias + "-posts-grid-load-more-visible"
                          ),
                          e.view.loadMoreContainer.classList.add(
                            y.a.alias + "-posts-grid-load-more-enabled"
                          ))
                        : (e.view.loadMore.classList.remove(
                            y.a.alias + "-posts-grid-load-more-visible"
                          ),
                          e.view.loadMoreContainer.classList.remove(
                            y.a.alias + "-posts-grid-load-more-enabled"
                          ));
                    });
                },
              },
              {
                ...
                value: function () {
                  var e = this;
                  S(I(n.prototype), "watch", this).call(this),
          ...
          return (
            ...
            e.colorPostBg &&
              (t +=
                ...
                " " +
                e.feedPrefix +
                "-posts-item-template-classic {\r\n            background: " +
                e.colorPostBg +
                ";\r\n        }\r\n\r\n        " +
                e.feedId +
                " " +
                e.feedPrefix +
                "-posts-item-user-image {\r\n            box-shadow: 0 0 0 2px " +
                e.colorPostBg +
                ";\r\n        }\r\n    "),
            (t += "\r\n\r\n    "),
            e.colorPostText &&
            ...
            e.colorPostLinks &&
              (t +=
                ...
                " " +
                e.feedPrefix +
                "-posts-item-content a:hover {\r\n            color: " +
                e.colorPostLinks +
                ";\r\n        }\r\n    "),
            (t += "\r\n\r\n    "),
            e.colorPostOverlayText &&
              (t +=
                "\r\n        " +
                e.feedId +
                " " +
            ...
            e.colorSliderArrows &&
              (t +=
                ...
                " " +
                e.feedPrefix +
                "-posts-slider-nav-icon {\r\n            fill: " +
                e.colorSliderArrows +
                ";\r\n        }\r\n    "),
            (t += "\r\n\r\n    "),
            e.colorSliderArrowsBg &&
              (t +=
                "\r\n        " +
                e.feedId +
                " " +
            ...
            e.colorPopupLinks &&
              (t +=
                ...
                "-item-text a:not(" +
                e.popupPrefix +
                "-item-text-author):hover,\r\n        " +
                e.popupId +
                " " +
                e.popupPrefix +
                "-item-comments-item-text a,\r\n        " +
                e.popupId +
                " " +
                e.popupPrefix +
                "-item-comments-item-text a:hover {\r\n            color: " +
                e.colorPopupLinks +
                ";\r\n        }\r\n    "),
            (t += "\r\n\r\n    "),
            e.colorPopupFollowButton &&
              (t +=
                "\r\n        " +
                e.popupId +
                " " +
                ...
                "-item ." +
                e.className +
                "-posts-item-user-follow-link a,\r\n        " +
                e.popupId +
                " " +
                e.popupPrefix +
                "-item ." +
                e.className +
                "-posts-item-user-follow-link a:hover {\r\n            color: " +
                e.colorPopupFollowButton +
                ";\r\n        }\r\n    "),
            (t += "\r\n\r\n    "),
            e.colorPopupCtaButton &&
              (t +=
                "\r\n        " +
                e.popupId +
                " a" +
