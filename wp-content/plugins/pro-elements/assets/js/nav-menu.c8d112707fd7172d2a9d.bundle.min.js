      ...
      var n = elementorModules.frontend.handlers.Base.extend({
        ...
        bindEvents() {
          this.elements.$menu.length &&
            ...
            elementorFrontend.addListenerOnce(
              this.$element.data("model-cid"),
              "scroll",
              this.debounce(this.reassignMobileMenuHeight, 250)
            ));
        },
        initStretchElement() {
          this.stretchElement =
        ...
        toggleMenu(e) {
          ...
          "boolean" != typeof e && (e = !t),
            ...
            this.reassignMobileMenuHeight(e),
            e &&
              this.getElementSettings("full_width") &&
        ...
        calculateStickyMenuNavHeight() {
          const e =
            this.elements.$dropdownMenu?.offset().top -
            jQuery(window).scrollTop();
          return elementorFrontend.elements.$window.height() - e;
        },
        isElementSticky() {
          return (
            this.$element.hasClass("elementor-sticky") ||
            this.$element.parents(".elementor-sticky").length
          );
        },
        getMenuHeight() {
        ...
        reassignMobileMenuHeight() {
          const e = this.elements.$menuToggle.hasClass("elementor-active")
            ? this.getMenuHeight()
            : 0;
