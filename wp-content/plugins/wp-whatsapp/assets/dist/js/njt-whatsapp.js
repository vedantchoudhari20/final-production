              ...
              return (
                ...
                (y.add = function (i, u) {
                  ...
                  var m = $.p(u),
                    h = function (t) {
                      var e = A(f);
                      return $.w(e.date(e.date() + Math.round(t * i)), f);
                    };
            ...
            _ = (function () {
              ...
              return (
                ...
                (g.add = function (t, e, n) {
                  var i;
                  return (
                    (i = e ? t * u[f(e)] : d(t) ? t.$ms : p(t, this).$ms),
                    p(this.$ms + i * (n ? -1 : 1), this)
                  );
                }),
            ...
            (c.tz = function (t, e) {
              ...
              var n = this.utcOffset(),
                ...
                c = r(a)
                  ...
                  .utcOffset(
                    15 * -Math.round(i.getTimezoneOffset() / 15) - s,
                    !0
                  );
              if (e) {
                var l = c.utcOffset();
            ...
            (c.startOf = function (t, e) {
              ...
              (r.tz = function (t, e, n) {
                ...
                var l = (function (t, e, n) {
                    ...
                    return r === o
                      ? [i, r]
                      : [t - 60 * Math.min(r, o) * 1e3, Math.max(r, o)];
      ...
      856: function (t) {
        t.exports = (function () {
          ...
          function X() {
            ...
            let { IS_ALLOWED_URI: ft } = G,
              mt = null;
            const ht = A({}, [...E, ...S, ...k, ...M, ...C]);
            let gt = null;
            const yt = A({}, [...O, ...L, ...R, ...I]);
            let _t = Object.seal(
                Object.create(null, {
              ...
              re = function (t) {
                if (!ee || ee !== t) {
                  if (
                    ...
                    (t = $(t)),
                    (Jt = Jt =
                      -1 === Kt.indexOf(t.PARSER_MEDIA_TYPE)
                        ? Qt
                        : t.PARSER_MEDIA_TYPE),
                    (te = "application/xhtml+xml" === Jt ? m : f),
                    (mt = "ALLOWED_TAGS" in t ? A({}, t.ALLOWED_TAGS, te) : ht),
                    (gt = "ALLOWED_ATTR" in t ? A({}, t.ALLOWED_ATTR, te) : yt),
                    (Xt =
                      "ALLOWED_NAMESPACES" in t
                        ? A({}, t.ALLOWED_NAMESPACES, m)
                        : Vt),
                    (Yt =
                      "ADD_URI_SAFE_ATTR" in t
                        ? A($(Wt), t.ADD_URI_SAFE_ATTR, te)
                        : Wt),
                    (Pt =
                      "ADD_DATA_URI_TAGS" in t
                        ? A($(Ft), t.ADD_DATA_URI_TAGS, te)
                        : Ft),
                    (Ht =
                      "FORBID_CONTENTS" in t
                        ? A({}, t.FORBID_CONTENTS, te)
                        : Ut),
                    (bt = "FORBID_TAGS" in t ? A({}, t.FORBID_TAGS, te) : {}),
                    (vt = "FORBID_ATTR" in t ? A({}, t.FORBID_ATTR, te) : {}),
                    (zt = "USE_PROFILES" in t && t.USE_PROFILES),
                    (wt = !1 !== t.ALLOW_ARIA_ATTR),
                    (Tt = !1 !== t.ALLOW_DATA_ATTR),
                    (At = t.ALLOW_UNKNOWN_PROTOCOLS || !1),
                    ($t = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR),
                    (xt = t.SAFE_FOR_TEMPLATES || !1),
                    ...
                    (kt = t.FORCE_BODY || !1),
                    (Ct = !1 !== t.SANITIZE_DOM),
                    (Ot = t.SANITIZE_NAMED_PROPS || !1),
                    (Rt = !1 !== t.KEEP_CONTENT),
                    (It = t.IN_PLACE || !1),
                    (ft = t.ALLOWED_URI_REGEXP || Y),
                    (qt = t.NAMESPACE || Gt),
                    (_t = t.CUSTOM_ELEMENT_HANDLING || {}),
                    t.CUSTOM_ELEMENT_HANDLING &&
                      ie(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
                      (_t.tagNameCheck =
                        t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                    t.CUSTOM_ELEMENT_HANDLING &&
                      ie(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
                      (_t.attributeNameCheck =
                        t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                    t.CUSTOM_ELEMENT_HANDLING &&
                      "boolean" ==
                        typeof t.CUSTOM_ELEMENT_HANDLING
                          .allowCustomizedBuiltInElements &&
                      (_t.allowCustomizedBuiltInElements =
                    ...
                    zt &&
                      ((mt = A({}, [...C])),
                      (gt = []),
                      !0 === zt.html && (A(mt, E), A(gt, O)),
                      !0 === zt.svg && (A(mt, S), A(gt, L), A(gt, I)),
                      !0 === zt.svgFilters && (A(mt, k), A(gt, L), A(gt, I)),
                      !0 === zt.mathMl && (A(mt, M), A(gt, R), A(gt, I))),
                    t.ADD_TAGS &&
                      (mt === ht && (mt = $(mt)), A(mt, t.ADD_TAGS, te)),
                    t.ADD_ATTR &&
                      (gt === yt && (gt = $(gt)), A(gt, t.ADD_ATTR, te)),
                    t.ADD_URI_SAFE_ATTR && A(Yt, t.ADD_URI_SAFE_ATTR, te),
                    t.FORBID_CONTENTS &&
                      (Ht === Ut && (Ht = $(Ht)), A(Ht, t.FORBID_CONTENTS, te)),
                    Rt && (mt["#text"] = !0),
                    Et && A(mt, ["html", "head", "body"]),
                    mt.table && (A(mt, ["tbody"]), delete bt.tbody),
            ...
            const ue = function (t) {
                ...
                return (
                  ...
                  (t.namespaceURI === Bt
                    ...
                    ? e.namespaceURI === Gt
                      ...
                      : Boolean(le[n])
                    : t.namespaceURI === Gt
                    ? !(e.namespaceURI === Bt && !ae[i]) &&
                      !(e.namespaceURI === jt && !oe[i]) &&
                      !le[n] &&
                      (se[n] || !ce[n])
                    : !("application/xhtml+xml" !== Jt || !Xt[t.namespaceURI]))
                );
              },
              de = function (t) {
                p(n.removed, { element: t });
                try {
              ...
              pe = function (t, e) {
                try {
                  p(n.removed, { attribute: e.getAttributeNode(t), from: e });
                } catch (t) {
                  p(n.removed, { attribute: null, from: e });
                }
              ...
              _e = function (t) {
                let e;
                if ((ye("beforeSanitizeElements", t, null), he(t)))
                  return de(t), !0;
                ...
                if (!mt[i] || bt[i]) {
                  if (!bt[i] && ve(i)) {
                    if (
                      _t.tagNameCheck instanceof RegExp &&
                      b(_t.tagNameCheck, i)
                    )
                      return !1;
                    if (
                      _t.tagNameCheck instanceof Function &&
                      _t.tagNameCheck(i)
                    )
                      return !1;
                  }
                  if (Rt && !Ht[i]) {
                    ...
                    if (n && e)
                      for (let i = n.length - 1; i >= 0; --i)
                        e.insertBefore(W(n[i], !0), j(t));
                  }
                  return de(t), !0;
                }
                return t instanceof w && !ue(t)
                  ? (de(t), !0)
                  ...
                  ? (xt &&
                      ...
                      (e = g(e, ct, " ")),
                      t.textContent !== e &&
                        (p(n.removed, { element: t.cloneNode() }),
                        (t.textContent = e))),
              ...
              be = function (t, e, n) {
                if (Ct && ("id" === e || "name" === e) && (n in a || n in ne))
                  return !1;
                if (Tt && !vt[e] && b(lt, e));
                else if (wt && b(ut, e));
                else if (!gt[e] || vt[e]) {
                    ...
                    !(
                      (ve(t) &&
                        ((_t.tagNameCheck instanceof RegExp &&
                          ...
                          (_t.tagNameCheck instanceof Function &&
                            _t.tagNameCheck(t))) &&
                        ((_t.attributeNameCheck instanceof RegExp &&
                          b(_t.attributeNameCheck, e)) ||
                          (_t.attributeNameCheck instanceof Function &&
                            _t.attributeNameCheck(e)))) ||
                      ("is" === e &&
                        _t.allowCustomizedBuiltInElements &&
                        ((_t.tagNameCheck instanceof RegExp &&
                          b(_t.tagNameCheck, n)) ||
              ...
              we = function (t) {
                ...
                for (o = a.length; o--; ) {
                  e = a[o];
                  const { name: c, namespaceURI: l } = e;
                  if (
                    ((i = "value" === c ? e.value : _(e.value)),
                    (r = te(c)),
                    (s.attrName = r),
                    (s.attrValue = i),
                    (s.keepAttr = !0),
                  ...
                  if (be(u, r, i)) {
                    ...
                    try {
                      l ? t.setAttributeNS(l, c, i) : t.setAttribute(c, i),
                        d(n.removed);
                    } catch (t) {}
                  }
                }
              ...
              Te = function t(e) {
                ...
                for (
                  ...
                  ye("uponSanitizeShadowNode", n, null),
                    _e(n) || (n.content instanceof s && t(n.content), we(n));
            ...
            return (
              (n.sanitize = function (t) {
                ...
                if (
                  ...
                  (e = fe("\x3c!----\x3e")),
                    (r = e.ownerDocument.importNode(t, !0)),
                    (1 === r.nodeType && "BODY" === r.nodeName) ||
                    "HTML" === r.nodeName
                      ? (e = r)
                      : e.appendChild(r);
                else {
                  if (!Dt && !xt && !Et && -1 === t.indexOf("<"))
                    return K && Nt ? K.createHTML(t) : t;
                  if (((e = fe(t)), !e)) return Dt ? null : Nt ? Q : "";
                }
                e && kt && de(e.firstChild);
                const u = me(It ? t : e);
                for (; (o = u.nextNode()); )
                  _e(o) || (o.content instanceof s && Te(o.content), we(o));
                if (It) return t;
                if (Dt) {
                  if (Mt)
                  ...
                  return (
                    (gt.shadowroot || gt.shadowrootmode) &&
                      (a = rt.call(i, a, !0)),
                    a
                  );
                }
                let d = Et ? e.outerHTML : e.innerHTML;
                return (
                  Et &&
                    mt["!doctype"] &&
                    e.ownerDocument &&
                    ...
                    b(B, e.ownerDocument.doctype.name) &&
                    (d =
        ...
        g = function (t, e) {
          ...
          for (let i = 0; i < o.workHours.length; i++) {
            ...
            if (-1 === f(r, c)) {
              const i = p(c),
                r =
                  ((a = { hour: i.hours, minute: i.minutes }),
                  (s = { hour: n.get("hour"), minute: n.get("minute") }),
                  1e3 *
                    (3600 * (a.hour - s.hour) + 60 * (a.minute - s.minute))),
                o = l.duration(r),
                u = d(e.options.display.time_symbols),
                f = ` ${o.get("hours")}${u.hour}:${o.get("minutes")}${
                  u.minute
                } `;
      ...
      window.njtWhatsApp = {
        createButton: function (t, e) {
          ...
          (o += "round" == n.styles.type ? " wa__r_button" : " wa__sq_button"),
            (o += "online" == r ? " wa__stt_online" : " wa__stt_offline"),
                      ...
                      t.appendChild(
                        (() => {
                          ...
                          return (
                            ...
                            (t.innerHTML =
                              "online" === r
                                ? b().sanitize(n.i18n.online)
                                : b().sanitize(n.i18n.offline)),
                            t
                          );
                        })()
                      ),
              ...
              (() => {
                ...
                t.setAttribute("id", "nta-wa-gdpr"),
                  ...
                  (t.onchange = function (t) {
                    if (
                      t.target.checked &&
                      (m("nta-wa-gdpr", "accept", 30), "" != h("nta-wa-gdpr"))
                    ) {
                ...
                e.appendChild(t),
                  e.appendChild(
                    (() => {
                      ...
                      return (
                        (t.innerHTML = b().sanitize(
                          n.options.styles.gdprContent.replaceAll(
                            /\r\n\r\n/gm,
                            "<br/>"
                          )
                        )),
                ...
                return (
                  i.setAttribute("for", "nta-wa-gdpr"), i.appendChild(e), i
                );
              })()
            );
          ...
          u.setAttribute(
            ...
            "online" == r &&
              (u.style.backgroundColor = n.styles.backgroundColor),
            u.appendChild(s),
            u.appendChild(c),
            t.appendChild(u),
        ...
        createWidget: function (t, e) {
          ...
          r.setAttribute("class", "wa__btn_popup_txt"),
            r.appendChild(
              (() => {
                const t = document.createElement("span");
            ...
            (r.style.display = "ON" == i.isShowBtnLabel ? "block" : "none"),
            (r.style.left = "left" == i.btnPosition ? "100%" : "unset"),
            (r.style.right = "right" == i.btnPosition ? "100%" : "unset"),
            (r.style.marginRight = "right" == i.btnPosition ? "7px" : "0px"),
            (r.style.marginLeft = "left" == i.btnPosition ? "7px" : "0px"),
            (r.style.width = i.btnLabelWidth + "px");
          ...
          a.setAttribute("class", "wa__btn_popup"),
            ...
            (a.style.left =
              "left" == i.btnPosition
                ? parseInt(i.btnLeftDistance) + "px"
                : "unset"),
            (a.style.right =
              "right" == i.btnPosition
                ? parseInt(i.btnRightDistance) + "px"
                : "unset"),
            (a.style.bottom = parseInt(i.btnBottomDistance) + "px"),
            t.appendChild(a);
          const s = document.createElement("div");
          s.setAttribute("class", "wa__popup_heading"),
            (s.style.background = i.backgroundColor),
            s.append(
              (() => {
                const t = document.createElement("div");
                return (
                  (t.className = "wa__popup_title"),
                  (t.innerHTML = b().sanitize(i.title)),
                  (t.style.color = i.textColor),
                  t
                );
              })()
            ),
            s.append(
              (() => {
                ...
                return (
                  ...
                  (t.style =
                    "#fff" == i.textColor || "#ffffff" == i.textColor
                      ? "color: #D9EBC6"
                      : "color: " + i.textColor + "; opacity: 0.8"),
                  t
                );
              })()
            );
                            ...
                            e.appendChild(
                              (() => {
                                ...
                                return (
                                  ...
                                  (n +=
                                    "online" != i
                                      ? `<div class="wa__member_status">${i}</div>`
                                      : ""),
          ...
          "ON" === i.isShowPoweredBy &&
            ...
            "ON" === i.isShowScroll &&
              ((l.style.maxHeight = parseInt(i.scrollHeight) + "px"),
          ...
          (f.className = "wa__popup_chat_box"),
            ...
            (f.style.right =
              "right" == i.btnPosition
                ? parseInt(i.btnRightDistance) + "px"
                : "unset"),
            (f.style.bottom = parseInt(i.btnBottomDistance) + 72 + "px"),
            f.appendChild(l),
            t.appendChild(f);
        },
        ready: function (t) {
